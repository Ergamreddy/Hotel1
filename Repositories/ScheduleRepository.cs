...
public class ScheduleRepository : BaseRepository, IScheduleRepository
{
    ...
    {
        var query = $@"Insert Into Schedule(schedule_id,room_id,guest_id,check_in,check_out,guest_count)VALUES(@ScheduleId,@RoomId,@GuestId,@CheckIn,@CheckOut,@GuestCount) RETURNING *";
    ...
    {
        var query = $@"DELETE FROM Schedule WHERE stay_schedule_id = @ScheduleId";
